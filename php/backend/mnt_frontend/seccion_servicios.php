<?php
	...
	if($res['permiso_front'] == TRUE){
		...
		echo "<script>window.location='../security/adminlogin.php';</script>";
	}
	...
	if ($res6['estado_sesion'] == 0) {
		...
		echo "<script>window.location='../login/cerrar.php';</script>";
	}
	...
	<div class="container">
		<div class="panel panel-success" style="margin-top:80px;">
		  <div class="panel-heading">
		  	<p class="letra4x text-center" style="margin-top:10px;"><span class="icon-users" style="margin-right:20px;"></span>Gestor servicios</p>
		  </div>
