<?php  
	...
	$report->Cell(32, 10, '', 0);
	$report->Cell(90, 20, utf8_decode('Reporte individual tipos de usuario'), 0);
	$report->Ln(20);
	...
	$st = $cn->prepare("SELECT id_tipo_usuario, nombre_tipo_usuario, identificador_tipo_usuario, descripcion_tipo_usuario,
	...
	$report->Cell(90, 8, html_entity_decode($resultado['id_tipo_usuario']), 1, 0, 'C');
	$report->Ln(8);
	...
	$report->Cell(90, 8, html_entity_decode($resultado['descripcion_tipo_usuario']), 1, 0, 'C');
	$report->Ln(8);
